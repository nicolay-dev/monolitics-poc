...
settings = Config()
app_configs: Dict[str, Any] = {"title": "BFF-Web Data_adapter"}
...
async def app_startup():
    global tasks
    global eventos
    task1 = asyncio.ensure_future(suscribirse_a_topico("eventos-datos", "data_adapter-bff", "public/default/eventos-datos", eventos=eventos))
    tasks.append(task1)

...
def consumer_app():
    ...
    subscription_name = 'listener-data-adapter-subscription-app'
    ...
    try:
        while True:
            ...
            producer_data_adapter = client.create_producer('persistent://public/default/evento-data-adapter-topic')
            producer_data_adapter.send(msg.data())
